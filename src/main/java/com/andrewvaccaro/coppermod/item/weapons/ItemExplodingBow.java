...
public class ItemExplodingBow extends Item
{
    ...
    {
        this.itemIcon = p_94581_1_.registerIcon(CopperMod.MOD_ID + ":" + this.getUnlocalizedName().substring(5) + "_standby");
                                            //this.getIconString() + "_standby"); //the "standby" texture
        this.iconArray = new IIcon[bowPullIconNameArray.length];

        for (int i = 0; i < this.iconArray.length; ++i)
        {
            this.iconArray[i] = p_94581_1_.registerIcon(CopperMod.MOD_ID + ":" + this.getUnlocalizedName().substring(5) + "_" + bowPullIconNameArray[i]);
