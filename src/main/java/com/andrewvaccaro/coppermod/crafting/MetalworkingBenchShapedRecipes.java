 ...
 */
public class MetalworkingBenchShapedRecipes implements IRecipe
{
    ...
    public MetalworkingBenchShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public MetalworkingBenchShapedRecipes func_92100_c()
    {
