package com.andrewvaccaro.coppermod.crafting;
...
public class MetalworkingBenchCraftingManager {
    ...
    public static final MetalworkingBenchCraftingManager getInstance() {
        return instance;
    }

    private MetalworkingBenchCraftingManager() {
        recipes = new ArrayList();

        //Add recipes only for the metalworking bench
        this.addRecipe(new ItemStack(CopperModItems.copperAxe, 1), "cc ", "cs ", " s ", 'c', CopperModItems.copperIngot, 's', Items.STICK);


        Collections.sort(this.recipes, new MetalworkingBenchRecipeSorter(this));
    }

    public MetalworkingBenchShapedRecipes addRecipe(ItemStack p_92103_1_, Object... p_92103_2_) {
        String s = "";
        int i = 0;
        int j = 0;
        int k = 0;
        ...
        MetalworkingBenchShapedRecipes shapedrecipes = new MetalworkingBenchShapedRecipes(j, k, aitemstack, p_92103_1_);
