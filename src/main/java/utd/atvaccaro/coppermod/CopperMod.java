package utd.atvaccaro.coppermod;

import utd.atvaccaro.coppermod.block.*;
import utd.atvaccaro.coppermod.entity.EntityCyclops;
import utd.atvaccaro.coppermod.entity.EntityExplodingArrow;
import utd.atvaccaro.coppermod.handler.EntityHandler;
import utd.atvaccaro.coppermod.handler.FuelHandler;
import utd.atvaccaro.coppermod.handler.GuiHandler;
import utd.atvaccaro.coppermod.proxy.ClientProxy;
import utd.atvaccaro.coppermod.proxy.CommonProxy;
import utd.atvaccaro.coppermod.proxy.ServerProxy;
import utd.atvaccaro.coppermod.renderer.RenderExplodingArrow;
import utd.atvaccaro.coppermod.tileentity.TileEntityAlabasterOven;
import utd.atvaccaro.coppermod.worldgen.OreManager;
...
import utd.atvaccaro.coppermod.item.*;
...
public class CopperMod
{
    ...
    @SidedProxy(clientSide="utd.atvaccaro.coppermod.proxy.ClientProxy",
                serverSide="utd.atvaccaro.coppermodproxy.ServerProxy")
