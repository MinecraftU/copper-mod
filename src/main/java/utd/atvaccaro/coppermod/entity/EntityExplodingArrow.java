package utd.atvaccaro.coppermod.entity;
...
public class EntityExplodingArrow extends EntityArrow implements IProjectile
{
    ...
    public EntityExplodingArrow(World p_i1753_1_)
    {
        super(p_i1753_1_);
    ...
    public EntityExplodingArrow(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_)
    {
        super(p_i1754_1_);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityExplodingArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(p_i1755_1_);
        this.renderDistanceWeight = 10.0D;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DamageSource.causeThrownDamage(this, this);  //previously causeArrowDamage
                    }
                    else
                    {
                        damagesource = DamageSource.causeThrownDamage(this, this.shootingEntity);   //previously causeArrowDamage
                    }
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                    {
                        ...
                        {
                            //when arrow has hit an entity
                            //put createExplosion here
                            this.setDead();
                        }
                    }
                    else
